  ...
  return (
    <div>
        <div className='hiw-wrapper' id='how-it-works'>
            <div className="hiw-container border-b-1 border-b-red-500 bg-[#342603]/90 p-6 flex flex-col text-white justify-start">
                <div className="flex flex-col p-12">
                    <h1 className='text-green-500 font-semibold'>EXPERIENCE AFRICAN CuLTURE</h1>
                    <h2 className='font-bold text-4xl'>Engage with heritage through innovative tools</h2>
                    <div className="grid grid-cols-[1fr_1fr] grid-rows-[1fr_1fr] w-[100%] justify-start p-6 space-x-2 gap-4">
                        <div className="card flex flex-col hover:bg-[#342603]/30 mt-10 h-[25rem]">
                            <div className='m-0 p-0 left-0 top-0 overflow-hidden h-[16rem]'>
                                <img src="https://picsum.photos/600/400" alt="CulturaAi-HowItWorks" />
                            </div>
